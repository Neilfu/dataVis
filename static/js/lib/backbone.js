...
(function(root, factory) {
	...
	_.extend(Model.prototype, Events, {
		...
		_validate : function(attrs, options) {
			...
			var error = this.validationError = this.validate(attrs, options)
					|| null;
			if (!error)
				return true;
	...
	_.extend(View.prototype, Events, {
				...
				// within the
				// current view. This should be preferred to global lookups
				// where possible.
				$ : function(selector) {
				...
				// override, in order
				// to populate its element (`this.el`), with the appropriate
				// HTML. The
				...
				// Remove this view by taking the element out of the DOM, and
				// removing any
				...
				// Change the view's element (`this.el` property), including
				// event
				// re-delegation.
