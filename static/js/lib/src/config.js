...
define(function() {
			...
			var config = {
				...
				scatter : {
					...
					yAxisIndex : 0,
					// symbol: null, // 图形类型
					symbolSize : 4, // 图形大小，半宽（半径）参数，当图形为方向或菱形则总宽度为symbolSize *
									// 2
				...
				chord : {
					...
					sortSub : 'none', // can be 'none', 'ascending',
										// 'descending'
					startAngle : 90,
					clockWise : true,
					showScale : false,
					...
					// Source data matrix
					/**
					 * target -1--2--3--4--5- 1| x x x x x 2| x x x x x 3| x x x
					 * x x source 4| x x x x x 5| x x x x x
					 * 
				...
				markPoint : {
					symbol : 'pin', // 标注类型
					symbolSize : 10, // 标注大小，半宽（半径）参数，当图形为方向或菱形则总宽度为symbolSize
										// * 2
