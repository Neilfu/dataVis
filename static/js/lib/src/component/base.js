...
define(function(require) {
			...
			Base.prototype = {
				...
				reformOption : function(opt) {
					return zrUtil.merge(opt || {}, zrUtil
				...
				getItemStyleColor : function(itemColor, seriesIndex, dataIndex,
						data) {
					return typeof itemColor == 'function' ? itemColor(
							seriesIndex, dataIndex, data) : itemColor;
				...
				subPixelOptimize : function(position, lineWidth) {
					if (lineWidth % 2 == 1) {
						// position += position == Math.ceil(position) ? 0.5 :
						// 0;
