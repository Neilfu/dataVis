/**
 * echarts地图一般投射算法 modify from GeoMap v0.5.3 https://github.com/x6doooo/GeoMap
 * 
...
define(function(require) {
	...
	function pos2geo(obj, p) {
		var point = p instanceof Array ? [p[0] * 1, p[1] * 1] : [p.x * 1,
				p.y * 1]
	...
	var shapeBuilders = {
		path : function(xmlNode, scale) {
			...
			return {
				shapeType : 'path',
				path : path,
				cp : [(rect.x + rect.width / 2) * scale[0],
