/*
 * ! 配置requirejs和启动marionette Date: 2014-7-25
 */
requirejs.config({
			...
			paths : {
				...
				'screen_adaptation' : "app/widget/common/screen_adaptation",
				"tool" : "app/widget/common/tool"
				,
			},
...
require(['marionette',], function(DataInsightManager) {
			...
			// 启动app
			require(['app/widget/app', 'screen_adaptation'], function() {
