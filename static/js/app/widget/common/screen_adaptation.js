...
define(['jquery'], function($) {
	...
	function screen_adaptation() {
		...
		$("#show_region").height(leaveHeight
				- $("#switch_region").outerHeight(true) - 162 - 10 - 2 - 2);

		// 设置table_template_content的高度
		variable = $("#table_region").outerHeight()
				- $("#table_template_header").outerHeight()
		$("#table_template_content").height(variable);

		// 设置field_template_content的高度
		variable = $("#field_region").outerHeight()
				- $("#field_template_header").outerHeight()
