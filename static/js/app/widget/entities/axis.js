...
define([], function() {
	...
	var AxisEntity = DataInsightManager.module("Entities", function(Entities,
							...
							initialize : function() {
								this.on("axis:change", function(data) {
											...
											if (data.axis == "x")// 改变x轴的元素
												Entities.trigger("x:change",
														this.toJSON());
											else
												// 改变y轴的元素
												Entities.trigger("y:change",
														this.toJSON());
										}, this);
							}
							,
				...
				DataInsightManager.reqres.setHandler("axis:entities",
						function() {
